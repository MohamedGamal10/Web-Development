import "./Insert_Etisalat_Incident.css";
import { NavDropdown,Nav,Offcanvas,Container,Navbar} from 'react-bootstrap';
import axios from "axios";
import React, { useState } from "react";
import { Link } from 'react-router-dom';
import {Component} from 'react'; 
import Template from '../../Files/Etisalat_Template.xlsx'
import {Server_IP,Server_PORT} from '../Net_Conf'
export default class Insert_Etisalat_Incident extends Component{
  state = { 
  ...
  onFileUpload = () => { 
    ...
    axios.post("http://"+Server_IP+":"+Server_PORT+"/insert_etisalat_incident", formData).then((response) => {
        ...
        <>
            {[false].map((expand) => (
              <Navbar key={expand} bg="light" expand={expand} className="mb-3">
                <Container fluid>
                  <Navbar.Brand href="#">Insert Etisalat-Incedient</Navbar.Brand>
