...
namespace Mazr3a.Controllers
{
    public class SectorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Farm_Name,Sector_ID")] Sector sector)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Farm_Name,Sector_ID")] Sector sector)
        {
            if (id != sector.Id)
            {
                return NotFound();
